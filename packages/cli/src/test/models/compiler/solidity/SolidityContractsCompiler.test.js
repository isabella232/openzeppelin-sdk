...
// SPDX-License-Identifier: MIT contract Example05 { function f() public pure returns (string memory) { return "bla"; } }',
  };
  ...
  const anotherContract_Solc05 = {
    ...
    source:
      'pragma solidity ^0.6.0;
// SPDX-License-Identifier: MIT contract AnotherExample05 { function f() public pure returns (uint) { return 2; } }',
  };
...
// SPDX-License-Identifier: MIT contract ExampleWithWarnings05 { function f() public { } }',
  };
  ...
  const contractWithErrors_Solc05 = {
    ...
    source: 'pragma solidity ^0.6.0;
// SPDX-License-Identifier: MIT contract ExampleWithErrors05 { function f() public { return 2; } }',
  };
